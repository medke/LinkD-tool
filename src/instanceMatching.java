...
public class instanceMatching {
	...
	public static void FirstStep(int start, List<List<String>> listOfElements,List<String> listOfElement) throws UnsupportedEncodingException
	{
		
		
		
		for(int i=start;i<listOfElements.size();i++)
		{
			last=i;
	...
	List<String> listOfElement= new ParseFile("LinkedMDB.txt").getElement();
	...
	{
	try{
		FirstStep(last,listOfElements,listOfElement);
		if(last>=10108) break;
	}catch(Exception e){
